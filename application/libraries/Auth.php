 ...
 */
 ...
 //->where($this->ci->config->item('user_password_column', 'auth'), $data['contrasena'])
 ...
 //Insertamos datos de acceso
    ...
    //Guardamos en una sesssion la informacion del usuario actualizando la fecha y hora de la ultima session
 ...
 * @license https://tuyo.com.pe
 * @copyright Winner Systems S.A.C.
