					...
					<div class="row pad" style="padding-bottom: 0px;">
						...
						<div class="col-sm-6">
							<div class="pull-right">
								...
								<a href="<?php echo base_url('admin/condominio/V/1');?>" class="btn btn-default btn-sm" title="Cancelar"><i class="fa fa-undo" aria-hidden="true"></i> Cancelar </a>
								<?php } ?>
								<?php if($wa_tipo == 'V'){ ?>
								<a href="<?php echo base_url('admin/condominio/E/1');?>" class="btn btn-primary btn-sm" title="Editar"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar </a>
								<?php } ?>
							</div>
						</div>
					</div>
