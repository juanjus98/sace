									...
									<tbody>
										<tr>
											<td style="padding:36px 48px;display:block">
												...
												<?php echo utf8_decode('Solicitud de cotización');?>
												</h1>
											</td>
										</tr>
									</tbody>
										...
										<table border="0" cellpadding="20" cellspacing="0" width="100%"><tbody><tr>
											<td valign="top" style="padding:40px">
												<div style="color:#737373;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left">
													...
													<?php echo utf8_decode('Se ha recibido una nueva solicitud de cotización. Los detalles se muestran a continuación para su referencia:');?>
													</p>
