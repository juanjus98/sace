...
//echo '</pre>';
?>
<form name="frm-editar" id="frm-editar" method="post" action="<?php echo base_url(); ?>waadmin/carousel/editar/<?php echo $post['id']; ?>" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="titulo3" class="col-sm-2 control-label">Título Url:</label>
                <div class="col-sm-5">
                    <input type="text" name="titulo3" id="titulo3" class="form-control"  placeholder="Título boton" value="<?php echo $post['titulo3']; ?>">
                </div>
