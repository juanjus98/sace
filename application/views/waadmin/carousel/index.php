...
?>
<?php echo msj(); ?>
<form name="index_form" id="index_form" action="<?php echo base_url(); ?>waadmin/carousel/eliminar" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo base_url(); ?>waadmin/carousel/agregar" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Agregar</a>
                ...
                if (!empty($listado)) {
                    foreach ($listado as $item) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>waadmin/carousel/editar/<?php echo $item['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Editar</a>
                            </td>
                        </tr>
                        <?php
                    }
