...
//echo '</pre>';
?>
<form name="frm-editar" id="frm-editar" method="post" action="<?php echo base_url(); ?>waadmin/categorias_servicios/editar/<?php echo $post['id']; ?>" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="pull-right">
                        ...
                        <a href="<?php echo base_url(); ?>waadmin/categorias_servicios/index" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Cancelar</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="tab-content tab-wa">
                    <div role="tabpanel" class="tab-pane active" id="tab-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <?php
                                echo select_categorias("parent_id", "servicio_categoria", $post["parent_id"]);
                                ?>
                            </div>
                        </div>
