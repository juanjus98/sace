...
//echo '</pre>';
?>
<form name="frm-agregar" id="frm-agregar" method="post" action="<?php echo base_url(); ?>waadmin/clientes_galeria/agregar/<?php echo $post['cliente_id']; ?>" class="form-horizontal" enctype="multipart/form-data">
    <input type="hidden" name="cliente_id" id="cliente_id" value="<?php echo $post['cliente_id']; ?>" />
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="pull-right">
                        ...
                        <a href="<?php echo base_url(); ?>waadmin/clientes_galeria/index/<?php echo $post['cliente_id']; ?>" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Volver</a>
                    </div>
                </div>
            </div>
        </div>
