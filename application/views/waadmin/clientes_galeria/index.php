...
?>
<?php echo msj(); ?>
<form name="index_form" id="index_form" action="<?php echo base_url(); ?>waadmin/clientes_galeria/eliminar/<?php echo $cliente_info['id']; ?>" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo base_url(); ?>waadmin/clientes_galeria/agregar/<?php echo $cliente_info['id']; ?>" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Agregar imágen</a>
                        ...
                        <a href="<?php echo base_url(); ?>waadmin/clientes/index" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Voler</a>
                    </div>
