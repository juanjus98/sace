        ...
        <div class="row">
            <form name="frm-buscar" id="frm-buscar" method="post" action="" role="search">
                ...
                <div class="col-md-4">
                    ...
                    <a href="<?php echo base_url(); ?>waadmin/noticias_categoria/index" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Restablecer</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo msj(); ?>
<form name="index_form" id="index_form" action="<?php echo base_url(); ?>waadmin/noticias_categoria/eliminar" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo base_url(); ?>waadmin/noticias_categoria/agregar" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Agregar</a>
                ...
                if (!empty($listado)) {
                    foreach ($listado as $item) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>waadmin/noticias_categoria/editar/<?php echo $item['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Editar</a>
                            </td>
                        </tr>
                        <?php
                    }
