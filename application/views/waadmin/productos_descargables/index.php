...
?>
<?php echo msj(); ?>
<form name="index_form" id="index_form" action="<?php echo base_url(); ?>waadmin/productos_descargables/eliminar/<?php echo $producto_info['id']; ?>" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo base_url(); ?>waadmin/productos_descargables/agregar/<?php echo $producto_info['id']; ?>" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Agregar</a>
                ...
                if (!empty($listado)) {
                    foreach ($listado as $item) {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url(); ?>descargables/<?php echo $item['nombre_archivo']; ?>" target="_blank"><?php echo $item['titulo']; ?></a></td>
