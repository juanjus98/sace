            ...
            <form name="frm-buscar" id="frm-buscar" method="post" action="" role="search">
                <div class="col-md-2">
                    <select name="campo" class="form-control input-sm">
                        <?php
                        $campos = array(
                            "t1.nombre_corto" => "Nombre servicio"
                        );
                ...
                <div class="col-md-2">
                    <?php
                    $busqueda = "";
                    if(!empty($post['busqueda'])){
                        $busqueda = $post['busqueda'];
                    }
                    ?>
                    <input type="text" name="busqueda" class="form-control input-sm" placeholder="Busqueda" value="<?php echo $busqueda; ?>">
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    ...
                    <a href="<?php echo base_url(); ?>waadmin/servicios/index" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Restablecer</a>
                </div>
            </form>
        </div>
    </div>
                ...
                if (!empty($listado)) {
                    foreach ($listado as $item) {
                        ...
                        <tr>
                            ...
                            <td><?php echo character_limiter($item['resumen'], 50); ?></td>
                            <td><?php echo $item['agregar']; ?></td>
                            <td>
                                <!--<a href="<?php echo base_url(); ?>waadmin/servicios_galeria/index/<?php echo $item['id']; ?>" class="btn btn-primary btn-xs" data-toggle="tooltip"><span class="glyphicon glyphicon-camera" aria-hidden="true"></span> Galería</a>-->
                                <a href="<?php echo base_url(); ?>waadmin/servicios/editar/<?php echo $item['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Editar</a>
                            </td>
                        </tr>
                        <?php
                    }
